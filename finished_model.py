...
# f = []    
    ...
    #     print(x[0], "volume is FIVE")
    #     one.append(filename)
    #     o.append(prediction[0][1])
    
    # elif(prediction[0][6] > 0.8):
    #     print(x[0], "volume is SIX")
    #     two.append(filename)
    #     t.append(prediction[0][2])
    
    # elif(prediction[0][7] > 0.8):
    #     print(x[0], "volume is SEVEN")
    #     three.append(filename)
    #     th.append(prediction[0][3])
    
    # elif(prediction[0][8] > 0.8):
    #     print(x[0], "volume is EIGHT")
    #     four.append(filename)
    #     f.append(prediction[0][4])
    # elif(prediction[0][9] > 0.8):
    #     print(x[0], "volume is NINE")
    #     four.append(filename)
    #     f.append(prediction[0][4])
    # else:
    #     idx = np.where(prediction[0] == np.amax(prediction[0]))
